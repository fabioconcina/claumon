...
\date{Model version \textbf{v2.0} \enspace - \enspace 2026-06-02}
...
$\ge \unow$ automatically (no clip) and the band is right-skewed; only
the upper edge is capped at $1$. $\sigma_F$ above is retained as a symmetric
moment summary (and to parameterise the MC draws); $F$ remains the reported
point estimate.
